...
const Gallery = () => {
    ...
    return (
        <div className='w-[80%] mx-auto'>
            ...
            <div className='grid grid-cols-1 justify-between lg:grid-cols-3 gap-6'>
                <Link to='/category/marvel'>
                    <div className="card w-72 h-72 bg-base-100 hover:shadow-xl hover:shadow-zinc-400 shadow-xl image-full"  data-aos="fade-left" >
                ...
                <Link to="/category/batman">
                    <div className="card w-72 h-72 hover:shadow-xl hover:shadow-zinc-400  bg-base-100 shadow-xl image-full" data-aos="fade-bottom">
                ...
                <Link to='/category/dccomics'>
                    <div className="card w-72 hover:shadow-xl hover:shadow-zinc-400 h-72 bg-base-100 shadow-xl image-full" data-aos="fade-right">
